                                  ...
                                  <div class="row">
                                    <section class="col col-12">
                                      ...
                                      <label class="textarea">
                                        <textarea name="description" cols="100" rows="4">{{!empty($d->id) ? $d->description : old('description')}}</textarea>
                                      </label>
                                    </section>
                                    <section class="col col-12">
                                      Narration:
                                      <label class="textarea">
                                        <textarea name="narration" cols="100" rows="3">{{!empty($d->id) ? $d->narration : old('narration')}}</textarea>
                                      </label>
                                    </section>
                                  </div>
                                </div>
