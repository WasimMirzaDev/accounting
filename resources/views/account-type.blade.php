                         ...
                         <form method="post" id="dataForm2" class="smart-form" autocomplete="off" enctype="multipart/form-data" action="{{route($route_prefix.'save')}}">
                          ...
                          @endif
                            ...
                            <section class="col col-md-7">
                              ...
                              <div class="row">
                                <section class="col col-6">
                                   <label for="name" class="label" style="font-weight:bold;">Account Head:<span style="color:red;">*</span></label>
                                   <select class="select2" name="level1_id">
                                     <option value="">Select Account Head</option>
                                     @if(!empty($level1))
                                       @foreach($level1 as $l1)
                                         <option {{isset($r->level1_id) && $r->level1_id == $l1->id ? 'selected' : ''}} value="{{$l1->id}}">{{$l1->name}}</option>
                                       @endforeach
                                     @endif
                                   </select>
                                </section>
                            ...
                            <footer>
                              ...
                              Save
                               ...
                               <a href="{{route('account-type.show')}}"
