                            ...
                            <section class="col col-md-12">
                              <div class="row">
                                ...
                                <section class="col col-2">
                                  Short Name: <small style="color:red;">*</small>
                                  <label class="input">
                                    <input type="text" autocomplete="off" name="short_name" value="{{!empty($r->short_name) ? $r->short_name : old('short_name')}}" placeholder="">
                                  </label>
                                </section>
                              </div>
                              <div class="row">
                                <section class="col col-4">
                                   <label for="name" class="label" style="font-weight:bold;">Type:<span style="color:red;">*</span></label>
                                   <select class="select2" name="is_receiving">
                                     <option value="0" {{ !empty($r->name) && $r->is_receiving == 0 ? 'selected' : ''  }}>Payment</option>
                                     <option value="1" {{ !empty($r->name) && $r->is_receiving == 1 ? 'selected' : ''  }}>Receiving</option>
                                   </select>
                                </section>
                              </div>
                             </section>
                            ...
                            <tbody>
                               @if(!empty($list))
                                 ...
                                 <tr id="row_{{$l->id}}">
                                    <td>{{$l->name}}</td>
                                    <td>{{$l->short_name}}</td>
                                    <td>{{ $l->is_receiving == 1 ? 'Receiving' : 'Payment' }}</td>
