                           ...
                           <div class="row">
                             ...
                             <section class="col col-3">
                                ...
                                <select class="select2" name="l3_id" onchange="fetch_acc_detail(this)">
                                  ...
                                  @if(!empty($list))
                                    @foreach($list as $acc)
                                      <option myacc_num="{{$acc->acc_num}}" @if($acc->id == old('l3_id')) {{'selected'}} @endif myacc_type="{{$acc->name}}" value="{{$acc->id}}">
                                        {{$acc->name}}
                                      </option>
                                    @endforeach
                                  @endif
                                ...
                                <select class="select2" name="subtype" onchange="fetch_acc_detail(this)">
                                  ...
                                  @if(!empty($level2))
                                    @foreach($level2 as $acc)
                                      <option myacc_num="{{$acc->name}}" @if($acc->id == old('level1_id')) {{'selected'}} @endif myacc_type="{{$acc->name}}" value="{{$acc->id}}">
                                      {{$acc->name}}
                                      </option>
                                    @endforeach
                                  @endif
