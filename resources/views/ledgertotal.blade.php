       ...
       <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
          <div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" role="widget">
             <header role="heading">
                ...
                <h2>Accounts Ledger With Month Totals</h2>
                       ...
                       <div class="row">
                         <section class="col col-md-12">
                           <div class="row">
                             ...
                             <section class="col col-2">
                                <label for="name" class="label" style="margin-bottom: 0px;">Title:</label>
                             ...
                             <section class="col col-2">
                                Account #
                                  <label class="input"> <i class="icon-prepend fa fa-calculator"></i>
                                    <input type="text" class="readonly" autocomplete="off" name="vch_selected_date" value="{{old('vch_selected_date')}}" placeholder="Account# here" readonly id="vch_selected_date">
                                  </label>
                              </section>
                              <section class="col col-2">
                                Type 
                                  <label class="input"> <i class="icon-prepend fa fa-bank"></i>
                                    <input type="text" class="readonly" autocomplete="off" name="vch_selected_date" value="{{old('vch_selected_date')}}" placeholder="Type here" readonly id="vch_selected_date">
                                  </label>
                              </section>
                             <section class="col col-2">
